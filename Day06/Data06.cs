...
namespace Day06
{
    static class Data06
    {
         ...
         * In the second group, there is no question to which everyone answered "yes" (*0*).
         ...
         * -------
         * The sixth example was only provided for part 1, but manually calculated for part 2.
         */
        // Dictionary<input, [part1_answer, part2_answer]>
        public static readonly Dictionary<string, Tuple<int, int>> tests = new Dictionary<string, Tuple<int, int>>
        {
            { "abc", new Tuple<int, int>(3, 3) },
            { @"a
b
c", new Tuple<int, int>(3, 0) },
            { @"ab
ac", new Tuple<int, int>(3, 1)},
            { @"a
a
a
a", new Tuple<int, int>(1, 1) },
            { "b", new Tuple<int, int>(1, 1) },
            { @"abcx
abcy
abcz", new Tuple<int, int>(6, 3) }
        };

        // https://adventofcode.com/2020/day/6/input  find-and-replace: \r\n\r\n  ->  ",\r\n@"
